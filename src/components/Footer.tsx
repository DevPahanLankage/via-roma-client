      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-secondary">
              Crafting excellence in every detail. Experience luxury redefined.
            </p>
          ...
          <div className="col-span-2 md:col-span-3 grid grid-cols-2 gap-8 md:grid-cols-3">
        ...
        <div className="mt-12 border-t border-accent pt-8">
          <p className="text-sm text-accent-light text-center">
            © {currentYear} Via Roma. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
